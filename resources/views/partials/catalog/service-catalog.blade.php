<div class="col-xl-3">
                ...
                <li class="cat-item cat-parent">
                    ...
                    {{-- @if($category->servicesubs->count() > 0)
                        ...
                        <ul class="children">
                            ...
                            <li class="cat-item cat-parent">
                                <a href="{{route('front.service_category', [$category->slug, $subcategory->slug])}}{{!empty(request()->input('search')) ? '?search='.request()->input('search') : ''}}" class="category-link {{ isset($subcat) ? ($subcat->id == $subcategory->id ? 'active' : '') : '' }}">{{$subcategory->name}} <span class="count"></span></a>
                                ...
                                @if($subcategory->servicechilds->count()!=0)
                                    ...
                                    <ul class="children">
                                        ...
                                        <li class="cat-item ">
                                            <a href="{{route('front.service_category', [$category->slug, $subcategory->slug, $childelement->slug])}}{{!empty(request()->input('search')) ? '?search='.request()->input('search') : ''}}" class="category-link {{ isset($childcat) ? ($childcat->id == $childelement->id ? 'active' : '') : '' }}"> {{$childelement->name}} <span class="count"></span></a>
                                        </li>
                                        @endforeach
                                    </ul>
    ...
    <form id="attrForm" action="{{ route('front.service_category',[Request::route('category'),Request::route('subcategory'),Request::route('childcategory')]) }}" method="post">
