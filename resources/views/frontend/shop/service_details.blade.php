...
@section('content')
    ...
    <div class="full-row bg-light overlay-dark py-5"
        ...
        <div class="container">
            <div class="row text-center text-white">
                <div class="col-12">
                    <h3 class="mb-2 text-white">{{ __('Service Details') }}</h3>
                </div>
                <div class="col-12">
    ...
    <!-- breadcrumb -->
    @include('partials.service-details.top')
    ...
    <div class="full-row">
        <div class="container">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="woocommerce-tabs wc-tabs-wrapper ps-0 mt-0">
                        <div class="tab-content" id="pills-tabContent-one">
                            <div class="tab-pane fade show active woocommerce-Tabs-panel woocommerce-Tabs-panel--description mb-5 mt-4 text-justify" id="pills-description-one" role="tabpanel" aria-labelledby="pills-description-one-tab">
                                {!! clean($service->description, ['Attr.EnableID' => true]) !!}
                            </div>
                            <div class="tab-pane fade mb-5 mt-4" id="pills-information-one" role="tabpanel" aria-labelledby="pills-information-one-tab">
                                <div class="row">
                                    <div class="col-12 text-justify">
                                        {!! clean($service->policy, ['Attr.EnableID' => true]) !!}
                                    </div>
                                </div>
                            </div>
                            {{-- Comment Section --}}
            ...
            @if ($service->user_id != 0 && $service->user->products->count() > 0)
                <div class="col-lg-3">
                    ...
                    <div
                        ...
                        @foreach ($service->user->products->take(9)->chunk(3) as $chunk)
                            <div class="item">
                                                ...
                                                <div class="product-wrapper">
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <div class="product-price">
                                                            ...
                                                            <div class="on-sale">
                                                                <span>{{ round((int) App\Models\Product::whereId($prod['id'])->first()->offPercentage()) }}</span><span>%
                                                                    off</span></div>
                                                        </div>
                ...
                <div class="col-12">
                    <div class="products product-style-1 owl-mx-5">
                        <div
                            ...
                            @foreach (DB::table('products')->where('type', $service->type)->where('product_type', $service->product_type)->where('language_id', Session::has('language') ? Session::get('language') : 1)->take(12)->get() as $item)
                                <div class="item">
                                    <div class="product type-product">
                                        <div class="product-wrapper">
                                            <div class="product-image">
