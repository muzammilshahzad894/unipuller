									...
									<li class="login-profile-area">
										<a class="dropdown-toggle-1" href="javascript:;">
											<div class="user-img">
												...
												<img src="{{ Auth::user()->photo ? asset(Auth::user()->photo):asset('assets/common_img/user_ava.jpeg') }}" alt="">
												@else
												<img src="{{ Auth::user()->photo ? asset('assets/images/users/'.Auth::user()->photo ):asset('assets/common_img/user_ava.jpeg') }}" alt="">
												@endif
											</div>
										</a>
										<div class="dropdown-menu">
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a target="_blank" href="https://oss.unipuller.com/login" class="wave-effect"><i class="fas fa-eye mr-2"></i> {{ __('One Stop Solutions') }}</a>
							</li>
							...
							<li>
								<a href="#shopmenu2" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
									<i class="icofont-cart"></i>{{ __('Shops') }}
								</a>
								<ul class="collapse list-unstyled" id="shopmenu2" data-parent="#accordion">
									<li>
										<a href="{{ route('vendor-shop-index') }}"><span>{{ __('Manage Shops') }}</span></a>
									</li>
								</ul>
							</li>
							<li>
								<a href="#servicemenu2" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
									<i class="icofont-cart"></i>{{ __('Services') }}
								</a>
								<ul class="collapse list-unstyled" id="servicemenu2" data-parent="#accordion">
									<li>
										<a href="{{ route('vendor-services-index') }}"><span>{{ __('Manage Services') }}</span></a>
									</li>
								</ul>
							</li>
