                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST"
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Email Bangladesh') }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="email" class="input-field"
                                            placeholder="{{ __('Enter Email for Bangladesh') }}" name="email_BD"
                                            value="{{ $data->email_BD }}">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Phone for Bangladesh') }} *
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field"
                                            placeholder="{{ __('Enter Phone for Bangladesh') }}" name="phone_BD"
                                            value="{{ $data->phone_BD }}">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field" placeholder="{{ __('Enter Fax for Bangladesh') }}"
                                            name="fax_BD" value="{{ $data->fax_BD }}">
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                  <div class="col-lg-3">
                                      <div class="left-area">
                                          <h4 class="heading">
                                              {{ __('Street Address Bangladesh') }} *
                                          </h4>
                                      </div>
                                  </div>
                                  <div class="col-lg-6">
                                      <textarea name="street_BD" class="input-field" placeholder="Enter Street Address for Bangladesh"> {{ $data->street_BD }} </textarea>
                                  </div>
                              </div>
                                ...
                                <div class="row justify-content-center">
                                  <div class="col-lg-3">
                                      <div class="left-area">
                                          <h4 class="heading">
                                              {{ __('Contact Us Email Address Bangladesh') }} *
                                          </h4>
                                      </div>
                                  </div>
                                  <div class="col-lg-6">
                                      <div class="tawk-area">
                                          <textarea name="contact_email_BD"> {{ $data->contact_email_BD }} </textarea>
                                      </div>
                                  </div>
                              </div>
