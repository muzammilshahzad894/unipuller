            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-category-import') }}">{{ __('Bulk Upload') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="add-product-content">
            <div class="row">
                <div class="col-lg-12 p-5">
                    ...
                    <form id="geniusform" action="{{ route('admin-category-importsubmit') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-right">
                                <span style="margin-top:10px;"><a class="btn btn-primary" href="{{ asset('assets/category-csv-format.csv') }}">{{ __('Download Sample CSV') }}</a></span>
                            </div>
                        </div>
                        <hr>
