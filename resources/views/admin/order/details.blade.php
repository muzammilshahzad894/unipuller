                                    ...
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th width="45%">{{$order->order_type == 'service' ? __('Total Service') : __('Total Product') }}</th>
                                                    <td width="10%">:</td>
                ...
                <td width="45%">{{$order->shipping_zip == null ? $order->customer_zip : $order->shipping_zip}}</td>
                            ...
                            <div class="row">
                                    <div class="col-lg-12 order-details-table">
                                        <div class="mr-table">
                                            <h4 class="title">
                                                {{ $order->order_type == 'service' ? __('Service Ordered') : __('Products Ordered') }}
                                            ...
                                            <div class="table-responsive">
                                                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                        <thead>
                                                            <tr>
                                                            <tr>
                                                                <th>{{ $order->order_type == 'service' ? __('Service ID#') : __('Product ID#') }}</th>
                                                                <th>{{ __('Shop Name') }}</th>
                                                                <th>{{ __('Vendor Status') }}</th>
                                                                <th>{{ $order->order_type == 'service' ? __('Service title') : __('Product Title') }}</th>
                                                                <th>{{ __('Details') }}</th>
