            ...
            <div class="add-product-content1">
              <div class="row">
                <div class="col-md-6 offset-md-3">
                  ...
                  <div class="col-lg-7">
                    <select class="input-field" name="type" required="" value="">
                      <option value="1" @if($attr->type == 1) selected @endif> Product</option>
                      <option value="2" @if($attr->type == 2) selected @endif> Service</option>
                    </select>
                  </div>
                </div>
