...
Route::prefix('admin')->group(function () {
  ...
  //------------ ADMIN MANAGE CATEGORY SECTION ENDS------------
    ...
    //------------ ADMIN SERVICE CATEGORY SECTION------------
      Route::get('/service_category/datatables', 'Admin\ServiceCategoryController@datatables')->name('admin-service-cat-datatables'); //JSON REQUEST
      Route::get('/service_category', 'Admin\ServiceCategoryController@index')->name('admin-service-cat-index');
      Route::get('/service_category/create', 'Admin\ServiceCategoryController@create')->name('admin-service-cat-create');
      Route::post('/service_category/create', 'Admin\ServiceCategoryController@store')->name('admin-service-cat-store');
      Route::get('/service_category/edit/{id}', 'Admin\ServiceCategoryController@edit')->name('admin-service-cat-edit');
      Route::post('/service_category/edit/{id}', 'Admin\ServiceCategoryController@update')->name('admin-service-cat-update');
      Route::delete('/service_category/delete/{id}', 'Admin\ServiceCategoryController@destroy')->name('admin-service-cat-delete');
      Route::get('/service_category/status/{id1}/{id2}', 'Admin\ServiceCategoryController@status')->name('admin-service-cat-status');

    //------------ ADMIN SERVICE CATEGORY SECTION ENDS------------
    ...
    Route::group(['middleware' => 'permissions:bulk_product_upload'], function () {
      ...
      Route::get('/vendors/import', 'Admin\VendorController@import')->name('admin-vendor-import');
      Route::post('/vendors/import-submit', 'Admin\VendorController@importSubmit')->name('admin-vendor-importsubmit');
      Route::get('/category/import', 'Admin\CategoryController@import')->name('admin-category-import');
      Route::post('/category/import-submit', 'Admin\CategoryController@importSubmit')->name('admin-category-importsubmit');
      Route::get('/subcategory/import', 'Admin\SubCategoryController@import')->name('admin-subcategory-import');
      Route::post('/subcategory/import-submit', 'Admin\SubCategoryController@importSubmit')->name('admin-subcategory-importsubmit');
    });
...
Route::group(['middleware' => 'maintenance'], function () {
  ...
  Route::prefix('vendor')->group(function () {
    ...
    Route::group(['middleware' => 'vendor'], function () {
      ...
      Route::get('/load/cities/{id}/', 'Vendor\VendorController@cityload')->name('vendor-city-load'); //JSON REQUEST
      ...
      // vendor service section start
      Route::get('/services/datatables', 'Vendor\ServicesController@datatables')->name('vendor-services-datatables'); //JSON REQUEST
      Route::get('/services', 'Vendor\ServicesController@index')->name('vendor-services-index');
      Route::get('/services/create', 'Vendor\ServicesController@create')->name('vendor-services-create');
      Route::get('/services/edit/{id}', 'Vendor\ServicesController@edit')->name('vendor-services-edit');
      Route::post('/services/edit/{id}', 'Vendor\ServicesController@update')->name('vendor-services-update');
      Route::post('/services/store', 'Vendor\ServicesController@store')->name('vendor-services-store');
      Route::delete('/services/delete/{id}', 'Vendor\ServicesController@destroy')->name('vendor-services-delete');
      Route::get('/services/status/{id1}/{id2}', 'Vendor\ServicesController@status')->name('vendor-services-status');
      // vendor service section end
      ...
      Route::get('/gallery/service/show', 'Vendor\GalleryController@serviceshow')->name('vendor-service-gallery-show');
      Route::post('/gallery/service/store', 'Vendor\GalleryController@servicestore')->name('vendor-service-gallery-store');
      Route::get('/gallery/service  /delete', 'Vendor\GalleryController@servicedestroy')->name('vendor-service-gallery-delete');
      ...
      Route::get('/shop/datatables', 'Vendor\ShopController@datatables')->name('vendor-shop-datatables');
      Route::get('/shop', 'Vendor\ShopController@index')->name('vendor-shop-index');
      Route::get('/shop/create', 'Vendor\ShopController@create')->name('vendor-shop-create');
      Route::post('/shop/create', 'Vendor\ShopController@store')->name('vendor-shop-store');
      Route::get('/shop/edit/{id}', 'Vendor\ShopController@edit')->name('vendor-shop-edit');
      Route::post('/shop/edit/{id}', 'Vendor\ShopController@update')->name('vendor-shop-update');
      Route::delete('/shop/delete/{id}', 'Vendor\ShopController@destroy')->name('vendor-shop-delete');
      Route::get('/shop/status/{id1}/{id2}', 'Vendor\ShopController@status')->name('vendor-shop-status');
  ...
  Route::get('/load/cities/{id}/', 'Front\CatalogController@cityload')->name('front-city-load'); //JSON REQUEST
  ...
  Route::get('/vendor/shop_service/{id}', 'Front\FrontendController@vendorShopService')->name('vendor.shop.service');
  ...
  // load marketing products
  Route::get('/load/marketing/products', 'Front\FrontendController@loadMarketingProducts')->name('front.loadmarketing.products');
  Route::get('/load/news/products', 'Front\FrontendController@loadNewsProducts')->name('front.loadnews.products');
  // BLOG SECTION
  ...
  // SHOP AUTO SEARCH SECTION
  Route::get('/autosearch/shop/{slug}', 'Front\FrontendController@autoshopsearch');
  // SHOP AUTO SEARCH SECTION ENDS
  ...
  // PRODCT SECTION ENDS
  // SERVICE REVIEW
  Route::post('/service/review', 'Front\FrontendController@serviceReviewsubmit')->name('front.service.review.submit');
  Route::get('/service/view/review/{id}', 'Front\FrontendController@serviceReviews')->name('front.service.reviews');
  Route::get('/service/view/side/review/{id}', 'Front\FrontendController@sideserviceReviews')->name('front.service.side.reviews');
  ...
  Route::post('/service/comment/store', 'Front\FrontendController@serviceComment')->name('service.comment');
  Route::post('/service/comment/edit/{id}', 'Front\FrontendController@serviceCommentedit')->name('service.comment.edit');
  Route::get('/service/comment/delete/{id}', 'Front\FrontendController@serviceCommentdelete')->name('service.comment.delete');
  // COMMENT SECTION ENDS
  ...
  // SERVICE REPLY SECTION
  Route::post('/service/comment/reply/{id}', 'Front\FrontendController@serviceCommentReply')->name('service.comment.reply');
  Route::post('/service/comment/reply/edit/{id}', 'Front\FrontendController@serviceCommentReplyedit')->name('service.comment.reply.edit');
  Route::get('/service/comment/reply/delete/{id}', 'Front\FrontendController@serviceCommentReplydelete')->name('service.comment.reply.delete');
  // REPLY SECTION ENDS
