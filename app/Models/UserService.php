...
class UserService extends Model
{
    ...
    {
        return $this->hasMany('App\Models\Comment', 'service_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\Rating', 'service_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\ServiceGallery','service_id','id');
    }

    // public function ratings()
    // {
    //     return $this->hasMany('App\Models\Rating','service_id','service_id');
    // }
    ...
    {
        return $this->belongsTo('App\Models\ServiceCategory')->withDefault();
    }
