...
class User extends Authenticatable
{
    ...
    protected $fillable = ['name', 'photo', 'about', 'website', 'zip', 'city', 'state', 'country', 'address', 'phone', 'fax', 'email','password','affilate_code','verification_link','service_category_id', 'subcategory_id','shop_name','owner_name','shop_number','shop_address','reg_number','shop_message','is_vendor','shop_details','shop_image','shipping_cost','date','mail_sent','email_verified','email_token','reward'];
