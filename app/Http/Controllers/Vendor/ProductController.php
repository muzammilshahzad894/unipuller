    ...
    public function create($slug)
    {
        ...
        if($slug == 'physical'){
            if($this->gs->physical == 1){
                return view('vendor.product.create.physical',compact('cats','sign','shops', 'countries'));
            }else{
                return back();
            }
            ...
            if($this->gs->digital == 1){
                return view('vendor.product.create.digital',compact('cats','sign','shops', 'countries'));
            }else{
                return back();
            }
        }else if(($slug == 'license')){
            if($this->gs->license == 1){
                return view('vendor.product.create.license',compact('cats','sign','shops', 'countries'));
            }else{
                return back();
            }
